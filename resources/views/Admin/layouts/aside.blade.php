<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-end rotate-caret" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand d-flex align-items-center m-0" href="/admin/index" >
        <span class="font-weight-bold text-lg">الذهبية للحوم</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{Route('admin.options.index')}}">
            ...
            <span class="nav-link-text me-1">الاضافات</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{Route('admin.notification')}}">
            ...
            <span class="nav-link-text me-1">اشعارات التطبيق</span>
          </a>
        </li>
        <li class="nav-item">
